                     ...
                     <div className="card border border-light-subtle rounded-4">
                         ...
                         <div className="row">
                             ...
                             <div className="mb-5">
                                 ...
                                 <h4 className="text-center">Welcome, Let's Get Onboarded!</h4>
                             </div>
                             </div>
                         </div>
                         <form action="#!">
                             ...
                             <div className="col-12">
                                 ...
                                 < Link to="/dashboard"className="btn bsb-btn-xl btn-primary" type="submit">SignUp</Link>
                                 </div>
                             </div>
                             </div>
                         </form>
                         <div className="row">
                             ...
                             <div className="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                 <Link to="/login" className="link-secondary text-decoration-none">Do have an Account?</Link>
